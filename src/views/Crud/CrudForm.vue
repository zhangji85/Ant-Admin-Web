<template>
  <v-card>
    ...
    />
    <br />
    <v-form-parser :sourceData="columns" :defaultData="defaultData">
        ...
        >
          <a-input
            ...
            v-decorator="[
              scope.dataIndex,
              {
                rules: scope.formOptions.rules,
                initialValue: defaultData[scope.dataIndex]
              }
            ]"
          >
            <a-icon slot="prefix" type="user" />
            <a-icon
              v-if="defaultData[scope.dataIndex]"
              slot="suffix"
              type="close-circle"
            />
          </a-input>
